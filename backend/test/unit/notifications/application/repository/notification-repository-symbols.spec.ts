import { NOTIFY_ALARM_RESOLUTION_REPO_PORT } from 'src/notifications/application/repository/notify-alarm-resolution.repository';
import { NOTIFY_ALARM_WARD_REPO_PORT } from 'src/notifications/application/repository/notify-alarm-ward.repository';
import { NOTIFICATIONS_REPOSITORY_PORT } from 'src/notifications/application/repository/notifications.repository';
import { WRITE_NOTIFICATION_REPO_PORT } from 'src/notifications/application/repository/write-notification.repository';
