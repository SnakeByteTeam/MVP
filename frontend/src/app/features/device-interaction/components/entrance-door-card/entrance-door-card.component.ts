...
@Component({
	selector: 'app-entrance-door-card',
	standalone: true,
	templateUrl: './entrance-door-card.component.html',
	styleUrl: './entrance-door-card.component.css'
})
export class EntranceDoorCardComponent implements IDeviceCard {
