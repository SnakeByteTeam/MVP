...
import { WRITE_PLANT_STRUCTURE_REPO_PORT, WritePlantStructureRepoPort } from "src/plant/application/repository/write-plant-structure.repository";
...
export class WritePlantStructureAdapter implements WritePlantStructurePort {
    ...
    constructor(
        @Inject(WRITE_PLANT_STRUCTURE_REPO_PORT) private readonly writeStructureOnRepo: WritePlantStructureRepoPort
    ) {}
