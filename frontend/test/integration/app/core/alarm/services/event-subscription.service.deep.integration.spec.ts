...
describe('EventSubscriptionService', () => {
  ...
  it.skip('bootstrap delle room da plant all al login quando cache ward e vuota', () => {
  ...
  it.skip('non interrompe il realtime quando bootstrap plant all fallisce', () => {
  ...
  it.skip('refreshWardRoomSubscription riallinea le room joinate senza reload pagina', () => {
    httpClientSpy.get
