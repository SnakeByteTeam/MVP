...
import { FIND_ALL_AVAILABLE_PLANTS_PORT, type FindAllAvailablePlantsPort } from '../ports/out/find-all-available-plants.port';
                                     ...
                                     FindAllAvailablePlantsUseCase
{
  ...
  async findAllAvailablePlants(): Promise<Plant[]> {
    const plant: Plant[] | null = await this.findAllAvailablePlantsPort.findAllAvailablePlants();
