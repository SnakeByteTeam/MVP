...
INSERT INTO "user" (username, surname, name, password, first_access, roleId)
VALUES
    ('mrossi', 'Rossi', 'Mario', 'test', FALSE, 1),
    ('gbianchi', 'Bianchi', 'Gioia', 'test', FALSE, 1),
    ('lverdi', 'Verdi', 'Luca', 'test', FALSE, 1),
    ('asala', 'Sala', 'Anna', 'test', FALSE, 1),
    ('fneri', 'Neri', 'Franco', 'test', FALSE, 1),
        -- Nuovi operatori sanitari
    ('gcolombo', 'Colombo', 'Giuseppe', 'test', FALSE, 1),
    ('fferrari', 'Ferrari', 'Francesca', 'test', FALSE, 1),
    ('arusso', 'Russo', 'Antonio', 'test', FALSE, 1),
    ('cgallo', 'Gallo', 'Chiara', 'test', FALSE, 1),
    ('mromano', 'Romano', 'Matteo', 'test', FALSE, 1),
        -- Amministratori di sistema
    ('admin_mario', 'Draghi', 'Mario', 'test', FALSE, 2),
    ('admin_luigi', 'Einaudi', 'Luigi', 'test', FALSE, 2)
