...
@Module({
  ...
  providers: [
    ...
    { provide: GET_ALL_ALARMS_BY_REQUEST_PORT,    useClass: GetAllAlarmsByRequestRepository },
    ...
    { provide: FIND_ALL_ACTIVE_ALARMS_PORT,       useClass: FindAllActiveAlarmsRepository },
    { provide: FIND_ACTIVE_ALARM_BY_ID_PORT,      useClass: FindActiveAlarmByIdRepository },
    { provide: FIND_ACTIVE_ALARM_BY_RULE_ID_PORT, useClass: FindActiveAlarmByRuleIdRepository },
    { provide: SAVE_ACTIVE_ALARM_PORT,            useClass: SaveActiveAlarmRepository },
    { provide: RESOLVE_ACTIVE_ALARM_PORT,         useClass: ResolveActiveAlarmRepository },
  ],
