...
import type { Device } from '../../apartment-monitor/models/device.model';
import { AlarmButtonCardComponent } from './alarm-button-card/alarm-button-card.component';
import { BlindCardComponent } from './blind-card/blind-card.component';
import { EntranceDoorCardComponent } from './entrance-door-card/entrance-door-card.component';
import { FallSensorCardComponent } from './fall-sensor-card/fall-sensor-card.component';
import { LightCardComponent } from './light-card/light-card.component';
import { PresenceSensorCardComponent } from './presence-sensor-card/presence-sensor-card.component';
import { ThermostatCardComponent } from './thermostat-card/thermostat-card.component';
