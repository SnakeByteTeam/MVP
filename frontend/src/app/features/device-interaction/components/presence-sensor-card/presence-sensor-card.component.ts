...
@Component({
	selector: 'app-presence-sensor-card',
	standalone: true,
	templateUrl: './presence-sensor-card.component.html',
	styleUrl: './presence-sensor-card.component.css'
})
export class PresenceSensorCardComponent implements IDeviceCard {
