...
import { MyVimarCloudApiFeatureService } from 'src/app/features/my-vimar-integration/services/my-vimar-cloud-api-feature.service';
import { VIMAR_CLOUD_API_SERVICE } from 'src/app/core/services/vimar-cloud-api.service.interface';
import { ALARM_CONFIGURATION_ROUTES } from 'src/app/features/alarm-configuration/alarm-configuration.routes';
import { ALARM_HISTORY_ROUTES } from 'src/app/features/alarm-history/alarm-history.routes';
import { ALARM_MANAGEMENT_ROUTES } from 'src/app/features/alarm-management/alarm-management.routes';
import { ANALYTICS_ROUTES } from 'src/app/features/analytics/analytics.routes';
import { APARTMENT_MONITOR_ROUTES } from 'src/app/features/apartment-monitor/apartment-monitor.routes';
import { DASHBOARD_ROUTES } from 'src/app/features/dashboard/dashboard-page.routes';
import { DEVICE_INTERACTION_ROUTES } from 'src/app/features/device-interaction/device-interaction.routes';
import { MY_VIMAR_INTEGRATION_ROUTES } from 'src/app/features/my-vimar-integration/my-vimar-integration.routes';
import { NOTIFICATION_ROUTES } from 'src/app/features/notification/notification.routes';
import { USER_MANAGEMENT_ROUTES } from 'src/app/features/user-management/user-management.routes';
import { WARD_MANAGEMENT_ROUTES } from 'src/app/features/ward-management/ward-management.routes';
